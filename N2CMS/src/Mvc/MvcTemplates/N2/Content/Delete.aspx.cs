	...
	public partial class Delete : Web.EditPage
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            else if (Engine.UrlParser.IsRootOrStartPage(selectedItem))
            {
				...
				this.Title = string.Format(GetLocalResourceString("DeletePage.TitleFormat", "Delete \"{0}\""), _title);
		...
		{
            string message = string.Format(GetLocalResourceString("confirm.message", "Delete {0} ({1})?"), _title, selectedItem.Url);
