...
namespace N2.Edit.FileSystem
{
    public partial class Directory1 : EditPage
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            ItemDefinition definition = Engine.Definitions.GetDefinition(typeof(Directory));
            hlNewDirectory.NavigateUrl = Engine.ManagementPaths.GetEditNewPageUrl(Selection.SelectedItem, definition, null, CreationPosition.Below);
        }
        ...
        protected void OnNewFolderCommand(object sender, EventArgs e)
        {
