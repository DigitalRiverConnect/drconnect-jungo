...
<asp:Content ContentPlaceHolderID="Toolbar" runat="server">
    <n2:OptionsMenu ID="om" runat="server">
		<asp:HyperLink ID="hlNewDirectory" runat="server" Text="New Folder" CssClass="command primary-action newfolder" meta:resourceKey="hlNewFolder" />
		<asp:LinkButton ID="btnDelete" runat="server" Text="Delete selected" CssClass="command action" OnCommand="OnDeleteCommand" meta:resourceKey="btnDelete" />
		<asp:HyperLink ID="hlEdit" runat="server" Text="Edit" CssClass="command action edit" meta:resourceKey="hlEdit" />
    </n2:OptionsMenu>
</asp:Content>
