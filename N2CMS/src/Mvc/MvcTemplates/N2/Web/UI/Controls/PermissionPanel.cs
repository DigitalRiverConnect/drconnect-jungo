...
namespace N2.Edit.Web.UI.Controls
{
	public class PermissionPanel : PlaceHolder
	{
		...
		protected override void Render(HtmlTextWriter writer)
		{
		    ...
		    var editPage = Page as EditPage; // optimize selection resolution
			var item = (editPage == null) ? new SelectionUtility(this, Page.GetEngine()).SelectedItem : editPage.Selection.SelectedItem;
