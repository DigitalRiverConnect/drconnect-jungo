...
namespace N2.Web
{
    ...
    public class UrlParser : IUrlParser
    {
        ...
        private bool ValidateStartPage = true;
        ...
        public virtual ContentItem StartPage
        {
            get
            {
                ...
                ContentItem startPage = persister.Repository.Get(host.CurrentSite.StartPageID); 
                if (ValidateStartPage)
                {
                    ValidateStartPage = false;
                    startPage = LocateStartPage(startPage);
                }
        ...
        {
            return item != null && (item.ID == host.CurrentSite.RootItemID || host.IsStartPage(item));
        }
