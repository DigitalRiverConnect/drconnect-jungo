...
namespace N2.Web
{
    ...
    public class WebRequestContext : IWebContext, IDisposable
    {
        ...
        public Url Url
        {
            // EG: Fix for N2 failing to work with URL rewrite: changed RawUrl to Url.PathAndQuery
			get { return new Url(HttpContext.Request.Url.Scheme, HttpContext.Request.Url.Authority, HttpContext.Request.Url.PathAndQuery); }
        }
