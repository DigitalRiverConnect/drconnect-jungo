...
namespace N2.Web.Mvc
{
	...
	public class ContentRoute : RouteBase
	{
		...
		{
		    if (HttpContext.Current.Items["RouteData"] != null) return ((Tuple<RouteData>) HttpContext.Current.Items["RouteData"]).Item1;
		...
		private RouteData GetRouteDataForPath(HttpRequestBase request)
		{
			...
			var url = new Url(request.Url.Scheme, host, request.Url.PathAndQuery);
			PathData path;
