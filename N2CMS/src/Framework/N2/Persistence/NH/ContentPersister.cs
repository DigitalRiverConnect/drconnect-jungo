...
namespace N2.Persistence
{
	...
	public class ContentPersister : IPersister, IFlushable
	{
        ...
        /// <summary>Occurs when an item is loaded</summary>
        public event EventHandler<EventArgs> FlushCache;

	    void IFlushable.Flush()
	    {
	        // fire a dummy event to wipe all cache dependencies
            EventHandler<EventArgs> handler = FlushCache;
	        if (handler != null)
