...
namespace N2.Persistence.Serialization
{
	public class ElementWriter : IDisposable
	{
		...
		{
            if (value.HasValue)
			    WriteAttribute(attributeName, SerializationUtility.ToUniversalString(value.Value));
        }

		public void WriteAttribute(string attributeName, string value, bool onlyNonEmpty = false)
		{
            if (value != null || !onlyNonEmpty)
