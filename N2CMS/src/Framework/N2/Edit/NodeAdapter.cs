...
namespace N2.Edit
{
	...
	public class NodeAdapter : AbstractContentAdapter
	{
		...
		{
            // if this is a file then there are no children (MAB).
            // it's important to short circuit this for files because if the file system
            // is relatively slow (e.g., Azure Blob Storage) then the HasChildren call is 
            // expensive.
            if (parent is IFileSystemFile)
                return false;
