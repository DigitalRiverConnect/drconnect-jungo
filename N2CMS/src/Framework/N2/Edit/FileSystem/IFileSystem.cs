...
namespace N2.Edit.FileSystem
{
	...
	public interface IFileSystem
	{
		...
		/// <param name="lastWriteTime">A System.DateTime containing the value to set for the last write date and time of path.</param>
		void WriteFile(string virtualPath, Stream inputStream, DateTime? lastWriteTime = null); // option 2: creates or updates a file at the given path (simpler than 1?)
