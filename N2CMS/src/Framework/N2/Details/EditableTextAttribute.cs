...
namespace N2.Details
{
	...
	public class EditableTextAttribute : AbstractEditableAttribute, IWritingDisplayable, IIndexableProperty, IContentEditable
	{
        ...
        public virtual string GetEditorCssClass()
        {
            return (TextMode == TextBoxMode.MultiLine) ? "wysiwyg" : "inplaceedit";
        }
