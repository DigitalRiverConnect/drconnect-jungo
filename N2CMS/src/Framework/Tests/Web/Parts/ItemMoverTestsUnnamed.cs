...
{
	[TestFixture]
	public class ItemMoverTestsUnnamed : ItemPersistenceMockingBase
	{
		...
		public void MovingPublishedItem_BetweenZones_CreatesDraft_ContainingChanges()
		{
            ...
            root.State.ShouldBe(ContentState.Published);
