...
namespace Demo
{
    ...
    {
        public override void WriteFile(string virtualPath, System.IO.Stream inputStream, DateTime? lastWriteTime = null)
        {
            ...
            base.WriteFile(virtualPath, inputStream, lastWriteTime);
        }
