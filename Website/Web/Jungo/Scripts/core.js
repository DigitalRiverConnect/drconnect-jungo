...
///#source 1 1 /Scripts/jquery.ba-postmessage.js
/*
...
///#source 1 1 /Scripts/jquery.ba-bbq.js
/*
...
///#source 1 1 /Scripts/backbone-min.js
...
///#source 1 1 /Scripts/html5.js
/*! HTML5 Shiv vpre3.6 | @afarkas @jdalton @jon_neal @rem | MIT/GPL2 Licensed
Uncompressed source: https://github.com/aFarkas/html5shiv  */
(function (a, b) { function h(a, b) { var c = a.createElement("p"), d = a.getElementsByTagName("head")[0] || a.documentElement; return c.innerHTML = "x<style>" + b + "</style>", d.insertBefore(c.lastChild, d.firstChild) } function i() { var a = l.elements; return typeof a == "string" ? a.split(" ") : a } function j(a) { var b = {}, c = a.createElement, f = a.createDocumentFragment, g = f(); a.createElement = function (a) { if (!l.shivMethods) return c(a); var f; return b[a] ? f = b[a].cloneNode() : e.test(a) ? f = (b[a] = c(a)).cloneNode() : f = c(a), f.canHaveChildren && !d.test(a) ? g.appendChild(f) : f }, a.createDocumentFragment = Function("h,f", "return function(){var n=f.cloneNode(),c=n.createElement;h.shivMethods&&(" + i().join().replace(/\w+/g, function (a) { return c(a), g.createElement(a), 'c("' + a + '")' }) + ");return n}")(l, g) } function k(a) { var b; return a.documentShived ? a : (l.shivCSS && !f && (b = !!h(a, "article,aside,details,figcaption,figure,footer,header,hgroup,nav,paging,resultCount,section{display:block}audio{display:none}canvas,video{display:inline-block;*display:inline;*zoom:1}[hidden]{display:none}audio[controls]{display:inline-block;*display:inline;*zoom:1}mark{background:#FF0;color:#000}")), g || (b = !j(a)), b && (a.documentShived = b), a) } var c = a.html5 || {}, d = /^<|^(?:button|form|map|select|textarea|object|iframe|option|optgroup)$/i, e = /^<|^(?:a|b|button|code|div|fieldset|form|h1|h2|h3|h4|h5|h6|i|iframe|img|input|label|li|link|ol|option|p|param|q|script|select|span|strong|style|table|tbody|td|textarea|tfoot|th|thead|tr|ul)$/i, f, g; (function () { var c = b.createElement("a"); c.innerHTML = "<xyz></xyz>", f = "hidden" in c, f && typeof injectElementWithStyles == "function" && injectElementWithStyles("#modernizr{}", function (b) { b.hidden = !0, f = (a.getComputedStyle ? getComputedStyle(b, null) : b.currentStyle).display == "none" }), g = c.childNodes.length == 1 || function () { try { b.createElement("a") } catch (a) { return !0 } var c = b.createDocumentFragment(); return typeof c.cloneNode == "undefined" || typeof c.createDocumentFragment == "undefined" || typeof c.createElement == "undefined" } () })(); var l = { elements: c.elements || "abbr article aside audio bdi canvas data datalist details figcaption figure footer header hgroup mark meter nav output paging progress resultCount section summary time video", shivCSS: c.shivCSS !== !1, shivMethods: c.shivMethods !== !1, type: "default", shivDocument: k }; a.html5 = l, k(b) })(this, document)
///#source 1 1 /Scripts/ms/fontfix.js
var ua, fontfix;
/(Windows Phone)|(XBLWP)|(ZuneWP)/.test(navigator.userAgent) && $("html").removeClass("fontface"),
			$("html").hasClass("fontface") || $("html").addClass("nofontface"),
			ua = navigator.userAgent.toLowerCase(), ua.indexOf("android") > -1 && ua.indexOf("android 4") === -1 && $("html").removeClass("cssanimations"),
			ua = navigator.userAgent.toLowerCase(), (ua.indexOf("android") > -1 || ua.indexOf("silk/") > -1) && (fontfix = document.createElement("style"), fontfix.setAttribute("type", "text/css"), fontfix.innerHTML = "", document.head.appendChild(fontfix))

///#source 1 1 /Scripts/ms/picture-polyfill.js
/* Picture polyfill
// Author: Tyson Matanich (tymat@microsoft.com)
//
// Based on W3C picture element proposal
// http://www.w3.org/community/respimg/wiki/Picture_Element_Proposal
------------------------------------------------------------------------------*/

//TODO: could add support for: orientation, aspect-ratio, device-aspect-ratio

(function (window) {

    var getDevicePixelRatio = function () {

        // Get the device pixel ratio, and default to 1
        if (typeof window.screen.systemXDPI != "undefined" && window.screen.systemXDPI >= window.screen.logicalXDPI) {
    ...
    var getDevicePixelWidth = function () {

        //TODO: Only assume reorientation on specific devices (mobile, tablet, etc). Will need to do some UA detection here :(
        var assumeReorientation = false;

        // Get the maximum screen dimension
        var screenRes = (assumeReorientation == false || window.screen.width > window.screen.height) ? window.screen.width : window.screen.height;

        // Increase size if window inner size is larger (Fix for multi display setups, especially IE)
        var windowRes = (assumeReorientation == false || window.innerWidth > window.innerHeight) ? window.innerWidth : window.innerHeight;
        if (windowRes > screenRes) {
            screenRes = windowRes;
        }

        // Multiply screen resolution by the device pixel ratio to get the actual phisical pixel dimension
        screenRes = screenRes * getDevicePixelRatio();

        return screenRes;
    };

    var getVieportWidth = function () {

        // Get the viewport width
        if (navigator.userAgent.toLowerCase().indexOf('webkit') > -1) {
            //TODO: Might have a bug in mobile safari
    ...
    var matchMedia = function (query) {
        ...
        if (query.length > 0) {
            ...
            //TODO: Allow a single rule to not be surrouned in "()"
            ...
            for (var i = 0, l = parts.length; i < l; i++) {
                ...
                var property = $.trim(parts[i].substring(0, j));

                // Get the property's value
                var value = $.trim(parts[i].substring(j + 1));
                //TODO: dont get the value until we know the property is supported
                ...
                switch (property) {
                    ...
                    // Minimum actual device width                                      
                    case "min-device-pixel-width":
                        value = removePX(value);
                        if (value > getDevicePixelWidth()) {
                    ...
                    case "min-device-pixel-ratio":
                        if (Number(value) > getDevicePixelRatio()) {
    ...
    var resolvePicture = function (element) {
        ...
        var sourceElements = $(element).find("div[data-src], div[data-srcset]").get();
        ...
        for (var i = sourceElements.length - 1; i >= 0; i--) {
            var isMatch = matchMedia(sourceElements[i].getAttribute("data-media"));
            if (isMatch == true) {

                if (sourceElements[i].getAttribute("data-srcset") !== null) {

                    //TODO: Bring to spec
                    // http://www.whatwg.org/specs/web-apps/current-work/multipage/embedded-content-1.html#attr-img-srcset

                    // Split into parts
                    var parts = sourceElements[i].getAttribute("data-srcset").split(",");

                    var item;
                    var foundSrcSetMatch = false;
                    for (var j = parts.length - 1; j >= 0; j--) {

                        item = $.trim(parts[j]);
                        var k = item.lastIndexOf(" ");

                        // Get the value
                        var value = $.trim(item.substring(k + 1, item.length - 1));
                        //TODO: Ensure it matches the following pattern /^[0-9]+(\.[0-9]+)?x$/

                        //TODO: Should there be rounding?
                        if (Number(value) <= getDevicePixelRatio()) {

                            // Found a match
                            matchSrc = $.trim(item.substring(0, k));
                            matchIndex = i;
                            break sourceLoop;
                        }
                    }
                    ...
                    // Found a match
                    matchSrc = sourceElements[i].getAttribute("data-src");
                    matchIndex = i;
                    break;
                }
            }
        ...
        if (typeof matchSrc != "undefined") {

            // Find the existing image
            var pictureElement = element.getElementsByTagName("img")[0];

            if (!pictureElement) {

                // Create the image for the first time
                pictureElement = window.document.createElement("img");
                pictureElement.alt = element.getAttribute("data-alt");
                element.appendChild(pictureElement);

            } else {

                // Check if the existing image should be updated
                var existingIndex = pictureElement.getAttribute("data-source-index");
                if ((element.getAttribute("data-dissable-swap-above") !== null && existingIndex >= matchIndex) || (element.getAttribute("data-dissable-swap-below") !== null && existingIndex <= matchIndex)) {
                    // Dont swap out the image
                    return;
                }
            ...
            pictureElement.src = matchSrc;
            pictureElement.setAttribute("data-source-index", matchIndex);
            ...
            element.innerHTML = noscriptElement.innerText; // +element.innerHTML;
    ...
    window.picturePolyfill.resolveLast = function () {

        // Get the first picture that has not yet been resolved and resolve it
        var el = $('div[data-picture]:not([data-resolved],[data-defer])').last().get()[0];
        if (el) {
            resolvePicture(el);
        }
    };

    window.picturePolyfill.init = function (resolveDeferredPictures) {
        ...
        // Get all mscom-picture elements
        var pictureElements = $('div[data-picture]').get();

        // Loop through the picture elements
        for (var i = 0, l = pictureElements.length; i < l; i++) {

            // Check if the picture uses deferred loading
            if ((pictureElements[i].getAttribute("data-resolved") === null || pictureElements[i].getAttribute("data-dissable-swap") === null)
                && (resolveDeferredPictures === true || pictureElements[i].getAttribute("data-defer") === null)) {

                // Resolve picture
                resolvePicture(pictureElements[i]);
    ...
    //TODO: Should we start resolving pictures before DOM ready has fired
    //window.picturePolyfill.init();

    // Add event listeners for DOM ready, onload, and resize events
    if (window.addEventListener) {
        window.addEventListener("resize", window.picturePolyfill.init, false);
        window.addEventListener("DOMContentLoaded", function () { window.picturePolyfill.init(false); }, false);
        window.addEventListener("load", window.picturePolyfill.init, false);
    } else if (window.attachEvent) {
        window.attachEvent("onload", window.picturePolyfill.init);
    }

})(window);

///#source 1 1 /Scripts/responsive/foundation.js
/*
* Foundation v4.3
*/
/*
...
///#source 1 1 /Scripts/responsive/foundation.orbit.js
/*
* Foundation v4.3
*/
;(function ($, window, document, undefined) {
  ...
  var Orbit = function(el, settings) {
    ...
    self._goto = function(next_idx, start_timer) {
      ...
      $(slides).removeClass(settings.active_slide_class);
...
///#source 1 1 /Scripts/responsive/foundation.section.js
/*
* Foundation v4.3
*/
/*jslint unparam: true, browser: true, indent: 2 */
...
///#source 1 1 /Scripts/responsive/app.js
$(function () {
    $(document).foundation('orbit', {
        ...
        after_slide_change: function (new_slide_number) {
            if (DR.HeroBannerPart) {
                DR.HeroBannerPart.handleAfterSlideChange(new_slide_number);
            }
        }
    });
    $(document).foundation('section', {
        ...
        rtl: false,
        callback: function () {
            if (DR.ProductExtendedDetailsPart) {
                DR.ProductExtendedDetailsPart.handleAfterTabChange();
            }
        }
    });
    // if you specify a .foundation('blahblah') for a particular module, you will need to do the same with all other modules I believe. looks like
    // others will not load if you specify parms for a particular one.
});
...
///#source 1 1 /Scripts/waypoints-min.js
...
///#source 1 1 /Scripts/waypoints-sticky.js
// Generated by CoffeeScript 1.4.0
